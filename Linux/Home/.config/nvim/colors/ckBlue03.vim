...
hi PreProc         guifg=#3869ad guibg=#0c0821 gui=NONE cterm=NONE
hi Special         guifg=#6abbc8 guibg=#0c0821 gui=NONE cterm=NONE
hi Constant        guifg=#c8a55a guibg=#0c0821 gui=NONE cterm=NONE
hi Comment         guifg=#c78b38 guibg=#3c2a11 gui=NONE cterm=NONE
hi Todo            guifg=#c8934d guibg=#0c0821 gui=NONE cterm=NONE
hi Identifier      guifg=#6756c8 guibg=#0c0821 gui=NONE cterm=NONE
hi Statement       guifg=#2c969b guibg=#0c0821 gui=NONE cterm=NONE
hi Type            guifg=#1fc8c8 guibg=#0c0821 gui=NONE cterm=NONE
hi TypeDef         guifg=#257f98 guibg=#0c0821 gui=NONE cterm=NONE
hi Title           guifg=#1d8ec7 guibg=#0c0821 gui=NONE cterm=NONE
hi Underlined      guifg=#6155be guibg=#0c0821 gui=NONE cterm=NONE
hi Search          guifg=#c8a75a guibg=#0c0821 gui=NONE cterm=NONE
hi FoldColumn      guifg=#4781c8 guibg=#0c0821 gui=NONE cterm=NONE
hi SignColumn      guifg=#af8628 guibg=#0c0821 gui=NONE cterm=NONE
...
hi NonText         guifg=#5e4fbf guibg=#0c0821 gui=NONE cterm=NONE
hi Normal          guifg=#574b9b guibg=#0c0821 gui=NONE cterm=NONE
hi LineNr          guifg=#473e74 guibg=#08070e gui=NONE cterm=NONE
hi CursorLineNr    guifg=#7164c8 guibg=#08070e gui=NONE cterm=NONE
hi StatusLine      guifg=#574b9b guibg=#08070e gui=NONE cterm=NONE
hi Pmenu           guifg=#667a99 guibg=#000000 gui=NONE cterm=NONE
hi PmenuSel        guifg=#c8a885 guibg=#2e271f gui=NONE cterm=NONE
hi Visual          guifg=#40a8bf guibg=#191339 gui=NONE cterm=NONE
hi WinBar          guifg=#3da7bd guibg=#0c0821 gui=NONE cterm=NONE

...
hi PreProc         guifg=#7856c8 guibg=#0e071d gui=NONE cterm=NONE
hi Special         guifg=#6649c8 guibg=#0e071d gui=NONE cterm=NONE
hi Constant        guifg=#309181 guibg=#0e071d gui=NONE cterm=NONE
hi Comment         guifg=#2ac89b guibg=#0d3f31 gui=NONE cterm=NONE
hi Todo            guifg=#502d8f guibg=#0e071d gui=NONE cterm=NONE
hi Identifier      guifg=#7a5dc8 guibg=#0e071d gui=NONE cterm=NONE
hi Statement       guifg=#1d9678 guibg=#0e071d gui=NONE cterm=NONE
hi Type            guifg=#169c78 guibg=#0e071d gui=NONE cterm=NONE
hi TypeDef         guifg=#38c89d guibg=#0e071d gui=NONE cterm=NONE
hi Title           guifg=#7b55c8 guibg=#0e071d gui=NONE cterm=NONE
hi Underlined      guifg=#7964c4 guibg=#0e071d gui=NONE cterm=NONE
hi Search          guifg=#8471c8 guibg=#0e071d gui=NONE cterm=NONE
hi FoldColumn      guifg=#641dc7 guibg=#0e071d gui=NONE cterm=NONE
hi SignColumn      guifg=#6d30c8 guibg=#0e071d gui=NONE cterm=NONE
...
hi NonText         guifg=#7943c9 guibg=#0e071d gui=NONE cterm=NONE
hi Normal          guifg=#734cc8 guibg=#0e071d gui=NONE cterm=NONE
hi LineNr          guifg=#59428a guibg=#0e071d gui=NONE cterm=NONE
hi StatusLine      guifg=#644b9b guibg=#09070e gui=NONE cterm=NONE
hi Pmenu           guifg=#66998f guibg=#000000 gui=NONE cterm=NONE
hi PmenuSel        guifg=#85c8ba guibg=#1f2e2b gui=NONE cterm=NONE
hi Visual          guifg=#7340bf guibg=#1f1339 gui=NONE cterm=NONE
hi WinBar          guifg=#3619b3 guibg=#0e071d gui=NONE cterm=NONE
